        ...
        <div class="col-12 margin-left-10 margin-bottom-15 border-radius-3">
            ...
            <div class="bg-white padding-20 d-flex justify-content-between">
                    ...
                    <form action="">
                        <div class="t-header-searchbox font-size-13">
                            <input type="text" class="text search-input__box font-size-13"
                                placeholder="جستجوی در کاربران">
                            <div class="t-header-search-content ">
                                <input type="text" class="text" name="key" placeholder="کد عضویت">
                ...
                <div class="">
                    ...
                    <a class="btn btn-yazdan" href="{{route('admin.users.create')}}">ایجاد کاربر</a>
                </div>
            </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr role="row" class="">
                            <td>{{$user->key}}</td>
                            <td>
                                <a href="{{$user->getAvatar()}}" target="_blank"><img src="{{$user->getAvatar(60)}}"
                                        class="profile_sm"></a>
                            </td>
                            <td>{{$user->username}}</td>
                            <td>{{$user->email}}</td>
                            ...
                            <td>
                                <ul class="scrollable">
                                    ...
                                    <li class="roleItem">
                                        {{__($role->name)}}
                                        <span class="tagRemove"
                                            onclick="deleteItem(event,'{{route('admin.users.removeRole',['user' => $user->id , 'role' => $role->id])}}','li')">x</span>
                                    </li>
                                    @empty
                                    کاربر عادی
                                    @endforelse
                            ...
                            <td>
                                ...
                                <a href="{{route('admin.users.edit',$user->id)}}" class="item-edit mlg-10"
                                    title="ویرایش"></a>
                                <a onclick="setFormAction({{$user->id}})" class="item-role  mlg-10" href="#rolesModal"
                                    rel="modal:open"></a>
                                <a href=""
                                    onclick="UpdateConfirmationStatus(event,'{{route('admin.users.manualVerify',$user->id)}}','تایید شده','آیا از تایید این کاربر اطمینان دارید ؟')"
